...
<div data-options="region:'center',title:'添加特卖信息'" style="padding:5px;">
	...
	<form id="saveSaleWindow" action="${rc.contextPath}/qqbsSale/save"  method="post">
		<fieldset>
            ...
            <br><br>
			 开始时间:<input value="<#if startTime?exists >${startTime}</#if>" id="startTime" name="startTime" /><span style="color:red">必须</span>;
			 结束时间:<input value="<#if endTime?exists >${endTime}</#if>" id="endTime" name="endTime" />
			 <span style="color:red">必须</span><br/><br/>
	...
	<div id="editProduct" style="width:800px;height:300px;padding:20px 20px;">
