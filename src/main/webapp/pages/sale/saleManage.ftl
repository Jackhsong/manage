...
<script src="${rc.contextPath}/pages/js/sale.js"></script>
</head>
...
<div data-options="region:'center',title:'特卖管理'" style="padding:5px;" id="main_panel">
		<div data-options="region:'north',title:'特卖管理',split:true" style="height: 120px;">
