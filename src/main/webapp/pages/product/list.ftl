...
<div data-options="region:'center'" style="padding: 5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		...
		<div data-options="region:'center'" >
    		...
    		<!-- 调库存begin -->
   	 		<div id="editStock_div" style="width:1100px;height:300px;padding:20px 20px;">
   	 			<p>
   	 				商品名称：<span id="span_baseName"></span>&nbsp;&nbsp;
	   	 			商品条码：<span id="span_barcode"></span>&nbsp;&nbsp;
	   	 			商品编码：<span id="span_code"></span>&nbsp;&nbsp;
   	 				商品名称：<span id="span_sellerName"></span>&nbsp;&nbsp;
   	 			</p>
   	 			<p>
			...
			<!-- 预览商品 begin-->
			<div id="previewPicture_div" class="easyui-dialog" style="width:800px;height:450px;padding:20px 20px;">
				<fieldset>
					<legend>主图</legend>
...
$(function(){
	...
	$(function(){
		$('#sellerId').combobox({
            	...
            	panelHeight:350,
				mode:'remote',
			    url:'${rc.contextPath}/qqbsSale/jsonSellerCode',   
			    valueField:'code',   
			    textField:'text'  
		});
		
		$('#brandId').combobox({   
			    url:'${rc.contextPath}/qqbsSale/jsonBrandCode',   
			    valueField:'code',   
			    textField:'text'  
		});
            ...
            columns:[[
                ...
                {field:'image',    title:'商品主图', width:30,align:'center',
					formatter:function(value, row, index){
						if(row.image1 == null || row.image1 == '' || row.image1 == undefined){
							return "<a href='http://www.cilu.com.cn/climg/images/goods11/goods11_a.jpg' target='_blank'><img alt='' src='http://www.cilu.com.cn/climg/images/goods11/goods11_a.jpg' style='max-height:80px'/></a>";
						}else{
                ...
                {field:'detailInfo1',    title:'详细信息', width:50, align:'left',
					formatter:function(value, row, index){						
						...
						return brandName + sellerName + sendAddress;
					}
				},
                {field:'detailInfo2',    title:'详细信息', width:40, align:'left',
                    formatter:function(value, row, index){
						...
						return manufacturerDate + expireDate + durabilityPeriod;
                    }
                },
