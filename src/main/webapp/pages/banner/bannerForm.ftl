...
<div data-options="region:'center',title:'添加Banner信息'" style="padding:5px;">
		...
		<fieldset>
			...
			<#else>
    		 ...
    		 Banner描述: <input type="text" maxlength="20" id="desc" name="desc" style="width:300px;"  value="<#if bannerWindow.desc?exists>${bannerWindow.desc}</#if>" /><br/><br/>
    		   网页链接url: <input type="text" maxlength="20" id="url" name="url" style="width:300px;"  value="<#if bannerWindow.url?exists>${bannerWindow.url}</#if>" /><br/><br/>
            ...
            <#else>
           	 ...
           	 开始时间:<input value="<#if endTime?exists >${bannerWindow.startTime}</#if>" id="startTime" name="startTime" /><span style="color:red">必须</span>
			 结束时间:<input value="<#if endTime?exists >${bannerWindow.endTime}</#if>" id="endTime" name="endTime" />
	...
	<div id="editProduct" style="width:800px;height:350px;padding:20px 20px;">
