...
<div data-options="region:'center',title:'banner管理'" style="padding:5px;">
	...
	$(function(){
		$('#s_data').datagrid({
            ...
            columns:[[
                ...
                {field:'url',    title:'对应名称/链接', width:60, align:'center',
                ...
                {field:'hidden',  title:'操作', width:120,align:'center',
                    formatter:function(value,row,index){
