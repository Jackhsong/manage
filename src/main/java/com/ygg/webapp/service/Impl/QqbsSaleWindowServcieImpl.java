...
import com.ygg.webapp.util.UrlEnum;
...
public class QqbsSaleWindowServcieImpl implements QqbsSaleWindowServcie
{
        ...
        throws Exception
    {
        ...
        for (QqbsSaleWindowEntity saleWindowEntity : saleWindowList)
        {
            ...
            if (saleWindowEntity.getSaleTimeType() ==2)
            {
                timePostfix = " 200000";
            }
            ...
            if (saleWindowEntity.getSaleTimeType() ==1)
            {
                saleTimeTypeStr = "早10点";
            }
            else if (saleWindowEntity.getSaleTimeType() == 2)
            {
                saleTimeTypeStr = "晚8点";
            }
