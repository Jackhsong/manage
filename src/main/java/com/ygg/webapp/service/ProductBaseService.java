...
public interface ProductBaseService
{
     ...
     * @throws Exception
     */
    int updateProductBase(ProductBaseEntity product, List<Map<String, Object>> mobileDetailsImageList,int saveType)
        throws Exception;
     ...
     * @throws Exception
     */
    int saveProductBase(ProductBaseEntity product, List<Map<String, Object>> mobileDetailsImageList)
        throws Exception;
    ...
    List<Integer> checkCodeAndBarCode(String code)
        throws Exception;
