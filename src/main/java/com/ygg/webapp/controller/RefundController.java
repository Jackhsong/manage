...
public class RefundController
{
    ...
    @ResponseBody
    public String jsonAll(HttpServletRequest request, 
		@RequestParam(value = "page", required = false, defaultValue = "1") int page,
        @RequestParam(value = "rows", required = false, defaultValue = "10") int rows,
        @RequestParam(value = "source", required = true) int source, // 1:listAll;2:listOnlyReturnMoney;3:listReturnMoneyAndGoods
        ...
        @RequestParam(value = "refundProportionStatus", required = false, defaultValue = "-1") int refundProportionStatus, // 退款分摊状态                                                                                                              // 1:已分摊
        ...
        @RequestParam(value = "startCheckTime", required = false, defaultValue = "") String startCheckTime, // 操作时间                                                                                                         // start
    ...
    public String agreeRefund(HttpServletRequest request, @RequestParam(value = "id", required = true) int id, //
        ...
        @RequestParam(value = "sendGoods", required = false, defaultValue = "false") boolean sendGoods, // step1 时
                                                                                                        // 该订单是否继续发货
        @RequestParam(value = "realSendGoodsCount", required = false, defaultValue = "") String realSendGoodsCount,                                                                                                             // 订单退款商品发货数量
        ...
        throws Exception
    {
        try
        {
            Map<String, Object> result = refundService.confirmGoods(id,remark);
            return JSON.toJSONString(result);
        }
        catch (Exception e)
        {
