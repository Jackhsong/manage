...
public class AreaDaoImpl extends BaseDaoImpl implements AreaDao
{
    ...
    public List<ProvinceEntity> findAllProvince()
        throws Exception
    {
        return getSqlSession().selectList("AreaMapper.findAllProvince");
    }
    ...
    public List<CityEntity> findAllCity()
        throws Exception
    {
        return getSqlSession().selectList("AreaMapper.findAllCitys");
    }
    ...
    public CityEntity findCityByCityId(String cityId)
        throws Exception
    {
        return getSqlSession().selectOne("AreaMapper.findCityByCityId", cityId);
    }
    ...
    public List<DistrictEntity> findAllDistrict()
        throws Exception
    {
        return getSqlSession().selectList("AreaMapper.findAllDistricts");
    }
    ...
    public List<Map<String, Object>> findCityCodeByPara(Map<String, Object> para)
        throws Exception
    {
        List<Map<String, Object>> reList = getSqlSession().selectList("AreaMapper.findCityCodeByPara", para);
    ...
    public List<Map<String, Object>> findDistrictCodeByPara(Map<String, Object> para)
        throws Exception
    {
        List<Map<String, Object>> reList = getSqlSession().selectList("AreaMapper.findDistrictCodeByPara", para);
        return reList == null ? new ArrayList<Map<String, Object>>() : reList;
    }
    ...
    public Set<String> findAllProvinceCode()
        throws Exception
    {
        List<String> reList = getSqlSession().selectList("AreaMapper.findAllProvinceCode");
